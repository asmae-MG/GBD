...
<body>
   <center>
	<h1> Rasp17_listerpersonnes_filtre_genre</h1>
	<h2> Partie IV : </h2>
	...
	<?php
		...
		{    	//verification de la connexion
			...
			//La fonction Renvoie le nouveau tableau
                ...
                // requete pour selectionner toutes les promos
  		$query  = "SELECT * FROM promo where 1";
  		$result = query_database($query);
	?>

 
	<form method= post action = "rasp17_affiche_promo_genre.php">
			<label for="id_p" > Choisir dans la liste : </label>
			<select id= "id_p" name ="idpromo">
		   
	      <?php 
			//Affichage des promos dans la liste déroulante
	      ...
	      ?>
				  ...
				  <input type="checkbox" id="id_g" name="genre2" value="femme">
				  <label for="genre1"> Femme</label><br>
				  <input type="checkbox" id="id_g" name="genre1" value="homme">
				  <label for="genre2"> Homme</label><br>
	   		 </select>
